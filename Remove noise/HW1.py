...
for i in range(0,562):
    for j in range(0,1000):
        for k in range(0,3):
            all_pixel = [original1[i,j,k],original2[i,j,k],original3[i,j,k],original4[i,j,k],original5[i,j,k],original6[i,j,k],original7[i,j,k],original8[i,j,k],original9[i,j,k],original10[i,j,k],original11[i,j,k],original12[i,j,k],original13[i,j,k],original14[i,j,k],original15[i,j,k],original16[i,j,k],original17[i,j,k],original18[i,j,k],original19[i,j,k]]
            all_pixel.sort()
            img[i,j,k] = all_pixel[10]
